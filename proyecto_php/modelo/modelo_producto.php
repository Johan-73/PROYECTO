...
require_once 'C:\xampp\htdocs\Practicas\Cerezos\PROYECTO\proyecto_php\config\dbconect.php';
    ...
    class modelo_producto{
        ...
        public function registroProducto( $Nombre, $Existencias, $ValorVenta, $Referencia, $Descripcion, $Categoria){
            ...
            $sql = "INSERT INTO producto (NOMBRE, EXISTENCIAS, VALORVENTA, REFERENCIA, DESCRIPCION) VALUES ('$Nombre', $Existencias, $ValorVenta, '$Referencia', '$Descripcion')";
